...
// Interpolate color from white to purple based on progress
var start_color = c_white;  // White at start
var end_color = make_color_rgb(100, 10, 100);  // Your purple orb color
