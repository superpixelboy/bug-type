...
collision_height = 50;  // How many pixels from bottom should block player
trunk_width = 275;          // Width of collision area
...
collision_obj.image_yscale = (collision_height / sprite_get_height(s_tree_collision_mask))*.5;
...
shadow_offset_y = 20;      // Below the tree base
