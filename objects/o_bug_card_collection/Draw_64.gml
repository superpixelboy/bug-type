...
var close_x = (ui_width - 60) * gui_scale; // Move LEFT (was -40, now -60)
var close_y = 10 * gui_scale; // Move UP (was 20, now 10)
var close_scale = gui_scale * 1; // Half the size (was 0.5, now 0.25)
