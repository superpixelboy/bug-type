...
collision_height = 153;  // How many pixels from bottom should block player
trunk_width = 360;       // Width of collision area

// Calculate trunk base position (where collision happens)
trunk_y = y + sprite_height - collision_height+153;

// Depth sorting - trees sort based on their trunk position
depth = -trunk_y+85;

// Create invisible collision object at trunk level
collision_obj = instance_create_layer(x+5, trunk_y, "Walls", o_tree_collision);
...
shadow_offset_y = 6;      // Below the tree base
