...
collision_height = 25;  // How many pixels from bottom should block player
trunk_width = 170;       // Width of collision area
...
shadow_offset_x = 5;      // Slight offset to the right
