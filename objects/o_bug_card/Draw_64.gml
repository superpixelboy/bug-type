...
if (show_front_content && content_ready) {
    ...
    // --- define the gem's base position ONCE (so we can mirror from it) ---
    ...
    if (gem_pop_scale > 0) {
        ...
        draw_sprite_ext(gem_sprite, 0, gem_x, gem_y,
                        ...
                        c_white, image_alpha * content_fade_alpha);
    }

  // ---- COIN (mirrored horizontally to upper-left corner) ----
if (gem_pop_scale > 0) {
    ...
    // Number (cream with dark outline)
